from tests.test_objects import test_marker
from tests.test_objects import test_node, test_tree
from allensdk.neuron_morphology.validation import marker_validation as mv
...
class TestMarkerValidationFunctions(ValidationTestCase):
    ...
    @patch("allensdk.neuron_morphology.validation.marker_validators", [mv])
