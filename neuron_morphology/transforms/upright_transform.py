...
class UprightTransform(object):
    ...
    def from_coords(cls, soma_coords, pia_coords, wm_coords):
        ...
        :param soma_coords: pandas dataframe of coordinates outlining the soma
        :type soma_coords: :py:class:`pandas.DataFrame`
        :param pia_coords: pandas dataframe of coordinates
            drawing the pia boundary
        :type pia_coords: :py:class:`pandas.DataFrame`
        :param wm_coords: pandas dataframe of coordinates
            drawing the wm boundary
        :type wm_coords: :py:class:`pandas.DataFrame`
        """
...
def convert_coords_str(coords_str: str, resolution: Optional[str] = None):
    ...
    coords = pd.DataFrame(data={'x': x, 'y': y}, dtype=float)
